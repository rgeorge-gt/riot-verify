...
1. **Data Source Information**  
   ...
   Data source is the Riot Games API. This is an API mananged by the developers of TeamFight Tactics. Within the API there exists multiple tables.
   Link:
...
3. **Data Structure and Format**  
   ...
   Structure of data.
   Currently, data is exported in JSON.
